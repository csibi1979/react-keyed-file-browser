...
return (window["webpackJsonpreact_keyed_file_browser"] = window["webpackJsonpreact_keyed_file_browser"] || []).push([[0],{
...
var DndProvider = __webpack_require__(98);
...
// EXTERNAL MODULE: ./node_modules/react-dnd/dist/esm/decorators/DropTarget.js + 3 modules
var DropTarget = __webpack_require__(102);
...
const TableHeader = Object(DropTarget["a" /* DropTarget */])(["file", "folder", esm["b" /* NativeTypes */].FILE], BaseFileConnectors.targetSource, BaseFileConnectors.targetCollect)(table_RawTableHeader);
...
// EXTERNAL MODULE: ./node_modules/react-dnd/dist/esm/decorators/DragSource.js + 3 modules
var DragSource = __webpack_require__(103);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/formatDistanceToNow/index.js + 8 modules
var formatDistanceToNow = __webpack_require__(100);
...
// EXTERNAL MODULE: ./node_modules/date-fns/esm/locale/hu/index.js + 5 modules
var hu = __webpack_require__(101);
    ...
    if (showModified) {
      if (!isRenaming && !isDeleting) {
        modified = /* @__PURE__ */ react_default.a.createElement("span", {
          className: "modified"
        }, "M\xF3dos\xEDtva: ", Object(formatDistanceToNow["a" /* default */])(this.props.modified, {addSuffix: true, locale: hu["a" /* default */]}));
      }
    }
    let rowProps = {};
    if (isSelectable) {
...
const ListThumbnailFile = flow_default()(Object(DragSource["a" /* DragSource */])("file", BaseFileConnectors.dragSource, BaseFileConnectors.dragCollect), Object(DropTarget["a" /* DropTarget */])(["file", "folder", esm["b" /* NativeTypes */].FILE], BaseFileConnectors.targetSource, BaseFileConnectors.targetCollect))(list_thumbnail_RawListThumbnailFile);
...
class table_RawTableFile extends base_file {
  render() {
    ...
    const row = /* @__PURE__ */ react_default.a.createElement("tr", {
      ...
      className: "modified"
    }, typeof modified === "undefined" ? "-" : Object(formatDistanceToNow["a" /* default */])(modified, {addSuffix: true})));
    return this.connectDND(row);
  }
}
const TableFile = flow_default()(Object(DragSource["a" /* DragSource */])("file", BaseFileConnectors.dragSource, BaseFileConnectors.dragCollect), Object(DropTarget["a" /* DropTarget */])(["file", "folder", esm["b" /* NativeTypes */].FILE], BaseFileConnectors.targetSource, BaseFileConnectors.targetCollect))(table_RawTableFile);
...
const ListThumbnailFolder = flow_default()(Object(DragSource["a" /* DragSource */])("folder", BaseFolderConnectors.dragSource, BaseFolderConnectors.dragCollect), Object(DropTarget["a" /* DropTarget */])(["file", "folder", esm["b" /* NativeTypes */].FILE], BaseFileConnectors.targetSource, BaseFileConnectors.targetCollect))(list_thumbnail_RawListThumbnailFolder);
...
const TableFolder = flow_default()(Object(DragSource["a" /* DragSource */])("folder", BaseFolderConnectors.dragSource, BaseFolderConnectors.dragCollect), Object(DropTarget["a" /* DropTarget */])(["file", "folder", esm["b" /* NativeTypes */].FILE], BaseFileConnectors.targetSource, BaseFileConnectors.targetCollect))(table_RawTableFolder);
...
var startOfMonth = __webpack_require__(97);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/endOfMonth/index.js
var endOfMonth = __webpack_require__(43);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/startOfToday/index.js + 1 modules
var startOfToday = __webpack_require__(104);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/endOfToday/index.js
var endOfToday = __webpack_require__(91);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/startOfYesterday/index.js
var startOfYesterday = __webpack_require__(92);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/endOfYesterday/index.js
var endOfYesterday = __webpack_require__(93);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/startOfWeek/index.js
var startOfWeek = __webpack_require__(94);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/endOfWeek/index.js
var endOfWeek = __webpack_require__(95);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/addWeeks/index.js + 1 modules
var addWeeks = __webpack_require__(105);

// EXTERNAL MODULE: ./node_modules/date-fns/esm/getMonth/index.js
var getMonth = __webpack_require__(96);
...
function relativeTimeWindows() {
  ...
  windows.push({
    name: "Today",
    begins: Object(startOfToday["a" /* default */])(),
    ends: Object(endOfToday["a" /* default */])(),
    items: []
  });
  windows.push({
    name: "Yesterday",
    begins: Object(startOfYesterday["a" /* default */])(),
    ends: Object(endOfYesterday["a" /* default */])(),
    items: []
  });
  windows.push({
    name: "Earlier this Week",
    begins: Object(startOfWeek["a" /* default */])(now),
    ends: Object(endOfWeek["a" /* default */])(now),
    items: []
  });
  windows.push({
    name: "Last Week",
    begins: Object(startOfWeek["a" /* default */])(Object(addWeeks["a" /* default */])(now, -1)),
    ends: Object(endOfWeek["a" /* default */])(Object(addWeeks["a" /* default */])(now, -1)),
    items: []
  });
  if (Object(getMonth["a" /* default */])(windows[windows.length - 1].begins) === Object(getMonth["a" /* default */])(now)) {
    windows.push({
      name: "Earlier this Month",
      begins: Object(startOfMonth["a" /* default */])(now),
      ends: Object(endOfMonth["a" /* default */])(now),
      items: []
    });
  }
  return windows;
...
/* harmony default export */ var by_modified = (function(files, root) {
  ...
  for (let fileIndex = 0; fileIndex < files.length; fileIndex++) {
    ...
    if (!allocated) {
      const newWindow = {
        name: Object(format["a" /* default */])(newFile.modified, "MMMM yyyy"),
        begins: Object(startOfMonth["a" /* default */])(newFile.modified),
        ends: Object(endOfMonth["a" /* default */])(newFile.modified),
        items: []
      };
...
function lastModifiedSort(allFiles) {
  ...
  files = files.sort(compareAsc["a" /* default */]);
  for (let folderIndex = 0; folderIndex < folders.length; folderIndex++) {
    const folder = folders[folderIndex];
